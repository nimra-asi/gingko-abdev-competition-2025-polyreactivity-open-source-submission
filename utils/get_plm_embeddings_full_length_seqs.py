...
df = df.rename(columns=({"SEC %Monomer": "SEC_perc_Monomer",
                         ...
                         "hc_protein_sequence": "hc",
                         "lc_protein_sequence": "lc"}))
...
df["full"] = df["hc"] + "<SEP>" + df["lc"]
sequences = df["full"].to_list()
print(len(sequences))
...
de.to_parquet('/Workspace/Users/nimra.asi.ext@boehringer-ingelheim.com/gingko-abdev-competition/data/precomputed_embeddings/full_length/gdpa1_full_esm2_mean_no_sep_embeddings.parquet', engine='pyarrow', index=False)
# de.to_parquet('/Workspace/Users/nimra.asi.ext@boehringer-ingelheim.com/gingko-abdev-competition/data/precomputed_embeddings/full_length/gdpa1_full_esm2_cls_embeddings.parquet', engine='pyarrow', index=False)
...
de.to_parquet('/Workspace/Users/nimra.asi.ext@boehringer-ingelheim.com/gingko-abdev-competition/data/precomputed_embeddings/full_length/gdpa1_full_antiberta2_embeddings.parquet', engine='pyarrow', index=False)
...
de.to_parquet('/Workspace/Users/nimra.asi.ext@boehringer-ingelheim.com/gingko-abdev-competition/data/precomputed_embeddings/full_length/gdpa1_full_antiberta2_cssp_embeddings.parquet', engine='pyarrow', index=False)
...
heavy_chains = df["hc"].to_list()
light_chains = df["lc"].to_list()
...
de.to_parquet('/Workspace/Users/nimra.asi.ext@boehringer-ingelheim.com/gingko-abdev-competition/data/precomputed_embeddings/full_length/gdpa1_full_igbert_mean_embeddings.parquet', engine='pyarrow', index=False)
...
de.to_parquet('gdpa1_lbster_embeddings.parquet', engine='pyarrow', index=False)
...
de.to_parquet('/Workspace/Users/nimra.asi.ext@boehringer-ingelheim.com/gingko-abdev-competition/data/precomputed_embeddings/full_length/gdpa1_full_ablang2_embeddings.parquet', engine='pyarrow', index=False)
...
embeddings_path = "/Workspace/Users/nimra.asi.ext@boehringer-ingelheim.com/gingko-abdev-competition/data/precomputed_embeddings/full_length/gdpa1_full_ablang2_embeddings.parquet"
...
embeddings_path = "/Workspace/Users/nimra.asi.ext@boehringer-ingelheim.com/gingko-abdev-competition/data/precomputed_embeddings/full_length/gdpa1_full_esm2_mean_no_sep_embeddings.parquet"
embeddings = pd.read_parquet(embeddings_path)
print(embeddings.shape)
